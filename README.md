...
| **Stacked pull requests** — GitHub PR stacks in the source-control UI; T3 Code has since shipped its own stack navigation, and MT Code keeps the local-stack workflow it built                                |   ✅    |                   ✅                    |
