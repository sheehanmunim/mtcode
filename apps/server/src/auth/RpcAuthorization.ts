...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverLoginProviderAccount]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverSubmitProviderLoginCode]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverLogoutProviderAccount]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.mtTeamsConfigure]: AuthOrchestrationOperateScope,
  [WS_METHODS.mtTeamsStatus]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.pullRequestsUpstreamRelease]: AuthOrchestrationReadScope,
  [WS_METHODS.pullRequestsMergeUpstreamRelease]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.sourceControlCloneRepositoryWithPrompts]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.vcsPullWithPrompts]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsPull]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitRunStackedActionWithPrompts]: AuthOrchestrationOperateScope,
