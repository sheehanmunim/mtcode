...
export function threadHasQueuedTurnStart(
  ...
  // Durable after-current messages remain work until dispatched or cancelled,
  // regardless of the adoption grace window.
  if (thread.hasQueuedTurns === true) return true;
