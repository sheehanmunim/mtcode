...
const makeNativeOperations = Effect.fn("PreviewManager.makeOperations")(function* (
  ...
  const captureAutomationSnapshot = Effect.fn("PreviewManager.captureAutomationSnapshot")(
    function* (
      ...
      const [sourceImage, diagnostics, timelines] = yield* Effect.all([
...
export class PreviewCaptureUnavailableError extends Schema.TaggedError<PreviewCaptureUnavailableError>()(
...
export class PreviewAutomationTargetHiddenError extends Schema.TaggedError<PreviewAutomationTargetHiddenError>()(
...
export class PreviewAutomationTargetDisabledError extends Schema.TaggedError<PreviewAutomationTargetDisabledError>()(
...
export class PreviewAutomationTargetAmbiguousError extends Schema.TaggedError<PreviewAutomationTargetAmbiguousError>()(
