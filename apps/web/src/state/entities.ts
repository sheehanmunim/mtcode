...
/**
 * Last unresolved thread-subscription failure, or null. Cleared by the runtime
 * as soon as a snapshot or live event lands, so a non-null value means the
 * stream is still failing its retries right now.
 */
