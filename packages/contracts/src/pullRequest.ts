...
// From the leaf module, never from `orchestration.ts`: that module imports this one for the
// pull request snapshot schemas, and importing it back would leave whichever side loads
// second reading a half-built first side.
